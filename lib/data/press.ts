...
export const pressMentions: PressMention[] = [
  {
    ...
    excerpt: "Katia Divina writes about finally finding an informal place in Trento to meet people and practice English and German — born from the idea of Gabriele Casagranda and Paolo Pelizzari.",
